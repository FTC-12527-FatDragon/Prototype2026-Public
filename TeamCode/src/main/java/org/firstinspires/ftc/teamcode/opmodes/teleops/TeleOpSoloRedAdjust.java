...
@Config
@Configurable
@TeleOp(name = "TeleOp Solo Red Adjust")
public class TeleOpSoloRedAdjust extends CommandOpMode {
    ...
    public void initialize() {
        ...
        drive = new VisionMecanumDrive(hardwareMap, VisionMecanumDrive.DriveState.RED, cds);
